...
_FORMULAS = {
    ...
    "RELU":       ("N*M", 1.29281e-09, 0.00523392,     "logistic1", 64.3431, 421.677, 1.20796, 26.8245),
    ...
    "TRANSPOSE":  ("N*M", 7.2924e-09, 0.00753521,       "logistic1", 51.4168, 406.984, 0.758696, 15.2999),
...
def estimate_with_fusion(nodes, stage=None, summary=None):
    ...
    if _hidden_dim > 0 and _num_layers > 0:
        ...
        _fw_energy = 3.4996e-07 * _hidden_dim * _num_ops
        total += _fw_energy
